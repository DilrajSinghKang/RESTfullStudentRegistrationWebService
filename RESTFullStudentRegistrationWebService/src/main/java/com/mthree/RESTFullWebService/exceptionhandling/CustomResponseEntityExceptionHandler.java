package com.mthree.RESTFullWebService.exceptionhandling;
...
public class CustomResponseEntityExceptionHandler extends ResponseEntityExceptionHandler {
	...
	public ExceptionResponse handleAllExceptions(Exception ex, WebRequest req) { 
		...
		ExceptionResponse exp = new ExceptionResponse(new Date(), ex.getMessage(),"Detailed description of an exception");
//		return new ResponseEntity(exp,HttpStatus.INTERNAL_SERVER_ERROR);
	...
	public ExceptionResponse handleUserNotFoundException(UserNotFoundException ex, WebRequest req) {
		...
		ExceptionResponse exp = new ExceptionResponse(new Date(), ex.getMessage(), "User with requested ID not Available");
